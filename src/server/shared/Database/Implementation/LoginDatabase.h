...
enum LoginDatabaseStatements
{
    ...
    */
    ...
    LOGIN_SEL_BATTLEPAY_DONATE_POINTS,
    LOGIN_UPD_BATTLEPAY_INCREMENT_DONATE_POINTS,
    LOGIN_UPD_BATTLEPAY_DECREMENT_DONATE_POINTS,

    LOGIN_SEL_BATTLEPAY_VIRTUAL_POINTS,
    LOGIN_UPD_BATTLEPAY_INCREMENT_VIRTUAL_POINTS,
    LOGIN_UPD_BATTLEPAY_DECREMENT_VIRTUAL_POINTS,

    LOGIN_INS_PANDARIA_TOKEN,
